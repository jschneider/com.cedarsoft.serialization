  ...
  public void testLegacyIndex() throws Exception {
    graphDb.registerTransactionEventHandler( new TransactionEventHandler<Object>() {
      ...
      public Object beforeCommit( TransactionData data ) throws Exception {
        System.out.println( "com.cedarsoft.serialization.neo4j.BasicNeo4JTest.beforeCommit" );
      ...
      public void afterCommit( TransactionData data, Object state ) {
        System.out.println( "com.cedarsoft.serialization.neo4j.BasicNeo4JTest.afterCommit" );
        System.out.println( data );
      }

      @Override
      public void afterRollback( TransactionData data, Object state ) {
        System.out.println( "com.cedarsoft.serialization.neo4j.BasicNeo4JTest.afterRollback" );
        System.out.println( data );
      }
    } );
