...
public abstract class Generator extends com.cedarsoft.codegen.AbstractGenerator {
  ...
  public abstract static class AbstractGeneratorRunner<T extends DecisionCallback> implements Runner {
    ...
    @Nonnull
    protected abstract com.cedarsoft.serialization.generator.common.output.serializer.test.AbstractGenerator<T> instantiateTestGenerator( @Nonnull CodeGenerator testCodeGenerator );
