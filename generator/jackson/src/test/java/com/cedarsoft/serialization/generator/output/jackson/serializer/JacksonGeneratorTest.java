 ...
 *
 */
public class JacksonGeneratorTest extends AbstractGeneratorTest {
  protected JacksonGenerator generator;

  @Before
  @Override
  public void setUp() throws Exception {
    super.setUp();
    generator = new JacksonGenerator( codeGenerator );
  }
  ...
  public void testSerializer() throws IOException, JClassAlreadyExistsException {
    ...
    assertGeneratedCode( getClass().getResource( "JacksonGeneratorTest.1.txt" ) );
  }
}
