...
public class DimensionSerializer extends AbstractStaxMateSerializer<Dimension> {
  ...
  @Override
  public void serialize( @NotNull SMOutputElement serializeTo, @NotNull Dimension object, @NotNull SerializationContext context ) throws IOException, XMLStreamException {
